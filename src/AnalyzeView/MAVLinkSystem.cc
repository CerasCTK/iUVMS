...
QGCMAVLinkSystem::QGCMAVLinkSystem(quint8 id, QObject *parent) : QObject(parent), _id(id), _messages(new QmlObjectListModel(this)) { qCDebug(MAVLinkSystemLog) << "New Vehicle:" << id; }
