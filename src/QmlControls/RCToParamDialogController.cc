...
RCToParamDialogController::RCToParamDialogController(QObject *parent)
    : QObject(parent), _scaleFact(new Fact(0, _scaleFactName, FactMetaData::valueTypeDouble, this)), _centerFact(new Fact(0, _centerFactName, FactMetaData::valueTypeDouble, this)),
      _minFact(new Fact(0, _minFactName, FactMetaData::valueTypeDouble, this)), _maxFact(new Fact(0, _maxFactName, FactMetaData::valueTypeDouble, this)) {
