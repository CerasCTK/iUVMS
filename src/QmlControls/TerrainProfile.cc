...
TerrainProfile::TerrainProfile(QQuickItem *parent) : QQuickItem(parent) {
...
void TerrainProfile::_updateSegmentCounts(
    FlightPathSegment *segment, int &cFlightProfileSegments, int &cTerrainProfilePoints, int &cMissingTerrainSegments, int &cTerrainCollisionSegments, double &minTerrainHeight, double &maxTerrainHeight
) {
...
bool TerrainProfile::_shouldAddMissingTerrainSegment(FlightPathSegment *segment) { return segment->amslTerrainHeights().count() == 0; }
