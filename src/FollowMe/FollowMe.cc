...
FollowMe::FollowMe(QObject *parent) : QObject(parent), _gcsMotionReportTimer(new QTimer(this)) {
...
FollowMe *FollowMe::instance() { return _followMeInstance(); }
...
bool FollowMe::_isFollowFlightMode(const Vehicle *vehicle, const QString &flightMode) { return (flightMode.compare(vehicle->followFlightMode()) == 0); }
