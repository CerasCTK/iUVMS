...
class JoystickConfigController : public FactPanelController {
  ...
  private:
    ...
    enum calStates { calStateAxisWait, calStateBegin, calStateIdentify, calStateMinMax, calStateCenterThrottle, calStateDetectInversion, calStateTrims, calStateSave };
    ...
    static constexpr const stateStickPositions stSticksCentered{ 0.25, 0.5, 0.75, 0.5 };

    static constexpr const stateStickPositions stLeftStickUp{ 0.25, 0.3084, 0.75, 0.5 };

    static constexpr const stateStickPositions stLeftStickDown{ 0.25, 0.6916, 0.75, 0.5 };

    static constexpr const stateStickPositions stLeftStickLeft{ 0.1542, 0.5, 0.75, 0.5 };

    static constexpr const stateStickPositions stLeftStickRight{ 0.3458, 0.5, 0.75, 0.5 };

    static constexpr const stateStickPositions stRightStickUp{ 0.25, 0.5, 0.75, 0.3084 };

    static constexpr const stateStickPositions stRightStickDown{ 0.25, 0.5, 0.75, 0.6916 };

    static constexpr const stateStickPositions stRightStickLeft{ 0.25, 0.5, 0.6542, 0.5 };

    static constexpr const stateStickPositions stRightStickRight{ 0.25, 0.5, 0.8423, 0.5 };
};
