...
//-----------------------------------------------------------------------------
ESP8266ComponentController::ESP8266ComponentController() : _waitType(WAIT_FOR_NOTHING), _retries(0) {
    for (int i = 1; i < 12; i++) {
...
int ESP8266ComponentController::componentID() { return MAV_COMP_ID_UDP_BRIDGE; }
...
void ESP8266ComponentController::setBaudIndex(int idx) {
    if (idx >= 0 && idx != baudIndex()) {
        int baud = 921600;
        switch (idx) {
            case 0: baud = 57600; break;
            case 1: baud = 115200; break;
            case 2: baud = 230400; break;
