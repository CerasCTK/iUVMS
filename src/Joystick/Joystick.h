...
class Joystick : public QThread {
  ...
  public:
    ...
    typedef enum { rollFunction, pitchFunction, yawFunction, throttleFunction, gimbalPitchFunction, gimbalYawFunction, maxFunction } AxisFunction_t;
  ...
  private:
    ...
    static constexpr const char *_rgFunctionSettingsKey[maxFunction] = { "RollAxis", "PitchAxis", "YawAxis", "ThrottleAxis", "GimbalPitchAxis", "GimbalYawAxis" };
