...
Viewer3DTerrainTexture::~Viewer3DTerrainTexture() { delete _terrainTileLoader; }
...
void Viewer3DTerrainTexture::loadTexture() {
    ...
    if (_osmParser->mapLoaded()) {
        ...
        _terrainTileLoader->adaptiveMapTilesLoader(_mapType, _mapId, _osmParser->getMapBoundingBoxCoordinate().first, _osmParser->getMapBoundingBoxCoordinate().second);
