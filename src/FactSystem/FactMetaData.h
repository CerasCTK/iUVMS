...
class FactMetaData : public QObject {
  ...
  private:
    ...
    enum UnitTypes { UnitHorizontalDistance = 0, UnitVerticalDistance, UnitArea, UnitSpeed, UnitTemperature, UnitWeight };
    ...
    static constexpr const char *_rgKnownTypeStrings[] = {
        "Uint8", "Int8", "Uint16", "Int16", "Uint32", "Int32", "Uint64", "Int64", "Float", "Double", "String", "Bool", "ElapsedSeconds", "Custom",
    };

    static constexpr const ValueType_t _rgKnownValueTypes[] = {
        valueTypeUint8,  valueTypeInt8, valueTypeUint16, valueTypeInt16, valueTypeUint32, valueTypeInt32, valueTypeUint64, valueTypeInt64, valueTypeFloat, valueTypeDouble, valueTypeString, valueTypeBool, valueTypeElapsedTimeInSeconds,
        valueTypeCustom,
    };
