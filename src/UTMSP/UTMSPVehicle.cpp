...
UTMSPVehicle::UTMSPVehicle(std::shared_ptr<Dispatcher> dispatcher, Vehicle *vehicle, QObject *parent) : UTMSPServiceController(parent), _dispatcher(dispatcher) {
...
void UTMSPVehicle::loadTelemetryFlag(bool value) { _remoteIDFlag = value; }
