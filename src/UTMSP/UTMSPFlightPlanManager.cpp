...
UTMSPFlightPlanManager::UTMSPFlightPlanManager() : _currentState(FlightState::Idle), _responseJSON(""), _responseStatus(false), _flightResponseID("") {}
...
void UTMSPFlightPlanManager::registerFlightPlan(const std::string &token, const json &boundaryPolygons, const int &minAltitude, const int &maxAltitude, const std::string &startDateTime, const std::string &endDateTime) {
              ...
              { "properties",
                {
                    ...
                    { "min_altitude", { { "meters", this->_flightData.flightDeclaration.features.properties.min_Altitude.meters }, { "datum", this->_flightData.flightDeclaration.features.properties.min_Altitude.datum } } },
                    { "max_altitude", { { "meters", this->_flightData.flightDeclaration.features.properties.max_Altitude.meters }, { "datum", this->_flightData.flightDeclaration.features.properties.max_Altitude.datum } } } } },
...
std::tuple<std::string, std::string, bool> UTMSPFlightPlanManager::registerFlightPlanNotification() { return std::make_tuple(_responseJSON, _flightResponseID, _responseStatus); }
