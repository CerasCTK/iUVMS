...
MavlinkCameraControl::MavlinkCameraControl(QObject *parent) : FactGroup(0, parent, true /* ignore camel case */) {}
...
QString MavlinkCameraControl::captureImageStatusToStr(uint8_t image_status) {
    switch (image_status) {
        ...
        case 1: return QStringLiteral("Capturing");
        case 2: return QStringLiteral("Idle: Interval set");
        case 3: return QStringLiteral("Capturing: Interval set");
...
QString MavlinkCameraControl::storageStatusToStr(uint8_t status) {
    switch (status) {
        case STORAGE_STATUS_EMPTY: return QStringLiteral("Empty");
        case STORAGE_STATUS_UNFORMATTED: return QStringLiteral("Unformatted");
        case STORAGE_STATUS_READY: return QStringLiteral("Ready");
        case STORAGE_STATUS_NOT_SUPPORTED: return QStringLiteral("Not Supported");
        default: return QStringLiteral("Unknown");
    }
}
