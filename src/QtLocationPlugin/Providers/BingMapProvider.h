...
class BingMapProvider : public MapProvider {
  protected:
    BingMapProvider(const QString &mapName, const QString &mapTypeCode, const QString &imageFormat, quint32 averageSize, QGeoMapType::MapStyle mapType)
        : MapProvider(mapName, QStringLiteral("https://www.bing.com/maps/"), imageFormat, averageSize, mapType), _mapTypeId(mapTypeCode) {}
...
class BingRoadMapProvider : public BingMapProvider {
  public:
    BingRoadMapProvider() : BingMapProvider(QStringLiteral("Bing Road"), QStringLiteral("r"), QStringLiteral("png"), AVERAGE_BING_STREET_MAP, QGeoMapType::StreetMap) {}
};

class BingSatelliteMapProvider : public BingMapProvider {
  public:
    BingSatelliteMapProvider() : BingMapProvider(QStringLiteral("Bing Satellite"), QStringLiteral("a"), QStringLiteral("jpg"), AVERAGE_BING_SAT_MAP, QGeoMapType::SatelliteMapDay) {}
};

class BingHybridMapProvider : public BingMapProvider {
  public:
    BingHybridMapProvider() : BingMapProvider(QStringLiteral("Bing Hybrid"), QStringLiteral("h"), QStringLiteral("jpg"), AVERAGE_BING_SAT_MAP, QGeoMapType::HybridMap) {}
};
