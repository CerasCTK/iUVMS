...
#ifndef UVMS_NO_GOOGLE_MAPS
    std::make_shared<GoogleStreetMapProvider>(),    std::make_shared<GoogleSatelliteMapProvider>(),    std::make_shared<GoogleTerrainMapProvider>(),
    std::make_shared<GoogleHybridMapProvider>(),    std::make_shared<GoogleLabelsMapProvider>(),
#endif
    std::make_shared<BingRoadMapProvider>(),        std::make_shared<BingSatelliteMapProvider>(),      std::make_shared<BingHybridMapProvider>(),

    std::make_shared<StatkartTopoMapProvider>(),    std::make_shared<StatkartBaseMapProvider>(),

    std::make_shared<EniroMapProvider>(),

    std::make_shared<EsriWorldStreetMapProvider>(), std::make_shared<EsriWorldSatelliteMapProvider>(), std::make_shared<EsriTerrainMapProvider>(),

    std::make_shared<MapboxStreetMapProvider>(),    std::make_shared<MapboxLightMapProvider>(),        std::make_shared<MapboxDarkMapProvider>(),
    std::make_shared<MapboxSatelliteMapProvider>(), std::make_shared<MapboxHybridMapProvider>(),       std::make_shared<MapboxStreetsBasicMapProvider>(),
    std::make_shared<MapboxOutdoorsMapProvider>(),  std::make_shared<MapboxBrightMapProvider>(),       std::make_shared<MapboxCustomMapProvider>(),

    std::make_shared<MapQuestMapMapProvider>(),     std::make_shared<MapQuestSatMapProvider>(),

    std::make_shared<VWorldStreetMapProvider>(),    std::make_shared<VWorldSatMapProvider>(),

    std::make_shared<JapanStdMapProvider>(),        std::make_shared<JapanSeamlessMapProvider>(),      std::make_shared<JapanAnaglyphMapProvider>(),
    std::make_shared<JapanSlopeMapProvider>(),      std::make_shared<JapanReliefMapProvider>(),
