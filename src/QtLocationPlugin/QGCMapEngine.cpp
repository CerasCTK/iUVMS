...
QGCMapEngine::QGCMapEngine(QObject *parent) : QObject(parent), m_worker(new QGCCacheWorker(this)) {
...
bool QGCMapEngine::addTask(QGCMapTask *task) { return m_worker->enqueueTask(task); }
