...
QGCMapEngineManager *QGCMapEngineManager::instance() { return _mapEngineManager(); }
...
QString QGCMapEngineManager::tileCountStr() const { return qgcApp()->numberToString(_imageSet.tileCount + _elevationSet.tileCount); }

QString QGCMapEngineManager::tileSizeStr() const { return qgcApp()->bigSizeToString(_imageSet.tileSize + _elevationSet.tileSize); }
...
void QGCMapEngineManager::taskError(QGCMapTask::TaskType type, const QString &error) {
    QString task;
    switch (type) {
        case QGCMapTask::taskFetchTileSets: task = QStringLiteral("Fetch Tile Set"); break;
        case QGCMapTask::taskCreateTileSet: task = QStringLiteral("Create Tile Set"); break;
        case QGCMapTask::taskGetTileDownloadList: task = QStringLiteral("Get Tile Download List"); break;
        case QGCMapTask::taskUpdateTileDownloadState: task = QStringLiteral("Update Tile Download Status"); break;
        case QGCMapTask::taskDeleteTileSet: task = QStringLiteral("Delete Tile Set"); break;
        case QGCMapTask::taskReset: task = QStringLiteral("Reset Tile Sets"); break;
        case QGCMapTask::taskExport: task = QStringLiteral("Export Tile Sets"); break;
        default: task = QStringLiteral("Database Error"); break;
    }
...
QStringList QGCMapEngineManager::mapList() { return UrlFactory::getProviderTypes(); }
...
QStringList QGCMapEngineManager::elevationProviderList() { return UrlFactory::getElevationProviderTypes(); }
