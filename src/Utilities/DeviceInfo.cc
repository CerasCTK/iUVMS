...
namespace QGCDeviceInfo {
    ...
    QGCAmbientTemperature *QGCAmbientTemperature::instance() { return s_ambientTemperature(); }

    QGCAmbientTemperature::QGCAmbientTemperature(QObject *parent) : QObject(parent), _ambientTemperature(new QAmbientTemperatureSensor(this)), _ambientTemperatureFilter(std::make_shared<QGCAmbientTemperatureFilter>()) {
        connect(_ambientTemperature, &QAmbientTemperatureSensor::sensorError, this, [](int error) { qCWarning(QGCDeviceInfoLog) << Q_FUNC_INFO << "QAmbientTemperature error:" << error; });
    ...
    QGCAmbientTemperature::~QGCAmbientTemperature() { qCDebug(QGCDeviceInfoLog) << Q_FUNC_INFO << this; }
    ...
    QGCAmbientTemperatureFilter::QGCAmbientTemperatureFilter() : QAmbientTemperatureFilter() { qCDebug(QGCDeviceInfoLog) << Q_FUNC_INFO << this; }

    QGCAmbientTemperatureFilter::~QGCAmbientTemperatureFilter() { qCDebug(QGCDeviceInfoLog) << Q_FUNC_INFO << this; }
    ...
    QGCPressure *QGCPressure::instance() { return s_pressure(); }

    QGCPressure::QGCPressure(QObject *parent) : QObject(parent), _pressure(new QPressureSensor(this)), _pressureFilter(std::make_shared<QGCPressureFilter>()) {
        connect(_pressure, &QPressureSensor::sensorError, this, [](int error) { qCWarning(QGCDeviceInfoLog) << Q_FUNC_INFO << "QPressure error:" << error; });
    ...
    QGCPressure::~QGCPressure() { qCDebug(QGCDeviceInfoLog) << Q_FUNC_INFO << this; }
    ...
    QGCPressureFilter::QGCPressureFilter() : QPressureFilter() { qCDebug(QGCDeviceInfoLog) << Q_FUNC_INFO << this; }

    QGCPressureFilter::~QGCPressureFilter() { qCDebug(QGCDeviceInfoLog) << Q_FUNC_INFO << this; }
    ...
    QGCCompass *QGCCompass::instance() { return s_compass(); }

    QGCCompass::QGCCompass(QObject *parent) : QObject(parent), _compass(new QCompass(this)), _compassFilter(std::make_shared<QGCCompassFilter>()) {
        // qCDebug(QGCDeviceInfoLog) << Q_FUNC_INFO << this;

        (void)connect(_compass, &QCompass::sensorError, this, [](int error) { qCWarning(QGCDeviceInfoLog) << Q_FUNC_INFO << "Compass error:" << error; });
    ...
    QGCCompassFilter::QGCCompassFilter() : QCompassFilter() { qCDebug(QGCDeviceInfoLog) << Q_FUNC_INFO << this; }

    QGCCompassFilter::~QGCCompassFilter() { qCDebug(QGCDeviceInfoLog) << Q_FUNC_INFO << this; }
