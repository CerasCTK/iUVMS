...
namespace QGCLZMA {
    ...
    bool inflateLZMAFile(const QString &lzmaFilename, const QString &decompressedFilename) {
        ...
        while (true) {
            ...
            switch (ret) {
                case XZ_STREAM_END: xz_dec_end(s); return true;
                case XZ_MEM_ERROR: qCWarning(QGCLZMALog) << "Memory allocation failed"; goto error;
                case XZ_MEMLIMIT_ERROR: qCWarning(QGCLZMALog) << "Memory usage limit reached"; goto error;
                case XZ_FORMAT_ERROR: qCWarning(QGCLZMALog) << "Not a .xz file"; goto error;
                case XZ_OPTIONS_ERROR: qCWarning(QGCLZMALog) << "Unsupported options in the .xz headers"; goto error;
                case XZ_DATA_ERROR:
                case XZ_BUF_ERROR: qCWarning(QGCLZMALog) << "File is corrupt"; goto error;
                default: qCWarning(QGCLZMALog) << "Bug!"; goto error;
            }
        }
