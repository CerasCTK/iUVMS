...
DECLARE_SETTINGGROUP(FlightMode, "FlightMode") { qmlRegisterUncreatableType<FlightModeSettings>("QGroundControl.SettingsManager", 1, 0, "FlightModeSettings", "Reference only"); }
