...
DECLARE_SETTINGGROUP(Units, "Units") { qmlRegisterUncreatableType<UnitsSettings>("QGroundControl.SettingsManager", 1, 0, "UnitsSettings", "Reference only"); }
...
DECLARE_SETTINGSFACT_NO_FUNC(UnitsSettings, horizontalDistanceUnits) {
    if (!_horizontalDistanceUnitsFact) {
        ...
        enumValues << QVariant::fromValue(static_cast<uint32_t>(HorizontalDistanceUnitsFeet)) << QVariant::fromValue(static_cast<uint32_t>(HorizontalDistanceUnitsMeters));
        ...
        switch (QLocale::system().measurementSystem()) {
            ...
            case QLocale::ImperialUKSystem: defaultHorizontalDistanceUnit = HorizontalDistanceUnitsFeet; break;
        }
...
DECLARE_SETTINGSFACT_NO_FUNC(UnitsSettings, verticalDistanceUnits) {
    if (!_verticalDistanceUnitsFact) {
        ...
        QVariantList enumValues;
        enumStrings << UnitsSettings::tr("Feet") << UnitsSettings::tr("Meters");
        enumValues << QVariant::fromValue(static_cast<uint32_t>(VerticalDistanceUnitsFeet)) << QVariant::fromValue(static_cast<uint32_t>(VerticalDistanceUnitsMeters));
        FactMetaData *metaData = new FactMetaData(FactMetaData::valueTypeUint32, this);
        ...
        switch (QLocale::system().measurementSystem()) {
            ...
            case QLocale::ImperialUSSystem:
            case QLocale::ImperialUKSystem: defaultVerticalAltitudeUnit = VerticalDistanceUnitsFeet; break;
        }
...
DECLARE_SETTINGSFACT_NO_FUNC(UnitsSettings, areaUnits) {
    if (!_areaUnitsFact) {
        ...
        enumValues << QVariant::fromValue(static_cast<uint32_t>(AreaUnitsSquareFeet)) << QVariant::fromValue(static_cast<uint32_t>(AreaUnitsSquareMeters)) << QVariant::fromValue(static_cast<uint32_t>(AreaUnitsSquareKilometers))
                   << QVariant::fromValue(static_cast<uint32_t>(AreaUnitsHectares)) << QVariant::fromValue(static_cast<uint32_t>(AreaUnitsAcres)) << QVariant::fromValue(static_cast<uint32_t>(AreaUnitsSquareMiles));
        FactMetaData *metaData = new FactMetaData(FactMetaData::valueTypeUint32, this);
        ...
        switch (QLocale::system().measurementSystem()) {
            ...
            case QLocale::ImperialUSSystem:
            case QLocale::ImperialUKSystem: defaultAreaUnit = AreaUnitsSquareMiles; break;
        }
...
DECLARE_SETTINGSFACT_NO_FUNC(UnitsSettings, speedUnits) {
    if (!_speedUnitsFact) {
        ...
        enumValues << QVariant::fromValue(static_cast<uint32_t>(SpeedUnitsFeetPerSecond)) << QVariant::fromValue(static_cast<uint32_t>(SpeedUnitsMetersPerSecond)) << QVariant::fromValue(static_cast<uint32_t>(SpeedUnitsMilesPerHour))
                   << QVariant::fromValue(static_cast<uint32_t>(SpeedUnitsKilometersPerHour)) << QVariant::fromValue(static_cast<uint32_t>(SpeedUnitsKnots));
        FactMetaData *metaData = new FactMetaData(FactMetaData::valueTypeUint32, this);
        ...
        switch (QLocale::system().measurementSystem()) {
            ...
            case QLocale::ImperialUSSystem:
            case QLocale::ImperialUKSystem: defaultSpeedUnit = SpeedUnitsMilesPerHour; break;
        }
...
DECLARE_SETTINGSFACT_NO_FUNC(UnitsSettings, temperatureUnits) {
    if (!_temperatureUnitsFact) {
        ...
        switch (QLocale::system().measurementSystem()) {
            ...
            case QLocale::ImperialUSSystem:
            case QLocale::ImperialUKSystem: defaultTemperatureUnit = TemperatureUnitsFarenheit; break;
        }
...
DECLARE_SETTINGSFACT_NO_FUNC(UnitsSettings, weightUnits) {
    if (!_weightUnitsFact) {
        ...
        enumValues << QVariant::fromValue(static_cast<uint32_t>(WeightUnitsGrams)) << QVariant::fromValue(static_cast<uint32_t>(WeightUnitsKg)) << QVariant::fromValue(static_cast<uint32_t>(WeightUnitsOz))
        ...
        switch (QLocale::system().measurementSystem()) {
            ...
            case QLocale::ImperialUSSystem: defaultWeightUnit = WeightUnitsOz; break;
        }
