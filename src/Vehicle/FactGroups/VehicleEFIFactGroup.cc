...
VehicleEFIFactGroup::VehicleEFIFactGroup(QObject *parent)
    : FactGroup(1000, ":/json/Vehicle/EFIFact.json", parent), _healthFact(0, _healthFactName, FactMetaData::valueTypeInt8), _ecuIndexFact(0, _ecuIndexFactName, FactMetaData::valueTypeFloat),
      _rpmFact(0, _rpmFactName, FactMetaData::valueTypeFloat), _fuelConsumedFact(0, _fuelConsumedFactName, FactMetaData::valueTypeFloat), _fuelFlowFact(0, _fuelFlowFactName, FactMetaData::valueTypeFloat),
      _engineLoadFact(0, _engineLoadFactName, FactMetaData::valueTypeFloat), _throttlePosFact(0, _throttlePosFactName, FactMetaData::valueTypeFloat), _sparkTimeFact(0, _sparkTimeFactName, FactMetaData::valueTypeFloat),
      _baroPressFact(0, _baroPressFactName, FactMetaData::valueTypeFloat), _intakePressFact(0, _intakePressFactName, FactMetaData::valueTypeFloat), _intakeTempFact(0, _intakeTempFactName, FactMetaData::valueTypeFloat),
      _cylinderTempFact(0, _cylinderTempFactName, FactMetaData::valueTypeFloat), _ignTimeFact(0, _ignTimeFactName, FactMetaData::valueTypeFloat), _injTimeFact(0, _injTimeFactName, FactMetaData::valueTypeFloat),
      _exGasTempFact(0, _exGasTempFactName, FactMetaData::valueTypeFloat), _throttleOutFact(0, _throttleOutFactName, FactMetaData::valueTypeFloat), _ptCompFact(0, _ptCompFactName, FactMetaData::valueTypeFloat) {
...
void VehicleEFIFactGroup::handleMessage(Vehicle * /* vehicle */, mavlink_message_t &message) {
    switch (message.msgid) {
        case MAVLINK_MSG_ID_EFI_STATUS: _handleEFIStatus(message); break;
        default: break;
    }
}
