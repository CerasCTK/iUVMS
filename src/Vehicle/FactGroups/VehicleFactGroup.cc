...
VehicleFactGroup::VehicleFactGroup(QObject *parent)
    : FactGroup(_vehicleUIUpdateRateMSecs, ":/json/Vehicle/VehicleFact.json", parent), _rollFact(0, _rollFactName, FactMetaData::valueTypeDouble), _pitchFact(0, _pitchFactName, FactMetaData::valueTypeDouble),
      _headingFact(0, _headingFactName, FactMetaData::valueTypeDouble), _rollRateFact(0, _rollRateFactName, FactMetaData::valueTypeDouble), _pitchRateFact(0, _pitchRateFactName, FactMetaData::valueTypeDouble),
      _yawRateFact(0, _yawRateFactName, FactMetaData::valueTypeDouble), _groundSpeedFact(0, _groundSpeedFactName, FactMetaData::valueTypeDouble), _airSpeedFact(0, _airSpeedFactName, FactMetaData::valueTypeDouble),
      ...
      _altitudeAboveTerrFact(0, _altitudeAboveTerrFactName, FactMetaData::valueTypeDouble), _altitudeTuningFact(0, _altitudeTuningFactName, FactMetaData::valueTypeDouble),
      ...
      _timeToHomeFact(0, _timeToHomeFactName, FactMetaData::valueTypeDouble), _missionItemIndexFact(0, _missionItemIndexFactName, FactMetaData::valueTypeUint16),
      _headingToNextWPFact(0, _headingToNextWPFactName, FactMetaData::valueTypeDouble), _distanceToNextWPFact(0, _distanceToNextWPFactName, FactMetaData::valueTypeDouble),
      _headingToHomeFact(0, _headingToHomeFactName, FactMetaData::valueTypeDouble), _distanceToGCSFact(0, _distanceToGCSFactName, FactMetaData::valueTypeDouble), _hobbsFact(0, _hobbsFactName, FactMetaData::valueTypeString),
      _throttlePctFact(0, _throttlePctFactName, FactMetaData::valueTypeUint16), _imuTempFact(0, _imuTempFactName, FactMetaData::valueTypeInt16) {
...
void VehicleFactGroup::handleMessage(Vehicle *vehicle, mavlink_message_t &message) {
    switch (message.msgid) {
        case MAVLINK_MSG_ID_ATTITUDE: _handleAttitude(vehicle, message); break;
        case MAVLINK_MSG_ID_ATTITUDE_QUATERNION: _handleAttitudeQuaternion(vehicle, message); break;
        case MAVLINK_MSG_ID_ALTITUDE: _handleAltitude(message); break;
        case MAVLINK_MSG_ID_VFR_HUD: _handleVfrHud(message); break;
        case MAVLINK_MSG_ID_NAV_CONTROLLER_OUTPUT: _handleNavControllerOutput(message); break;
        case MAVLINK_MSG_ID_RAW_IMU: _handleRawImuTemp(message); break;
#ifndef NO_ARDUPILOT_DIALECT
        case MAVLINK_MSG_ID_RANGEFINDER: _handleRangefinder(message); break;
#endif
        default: break;
    }
}
