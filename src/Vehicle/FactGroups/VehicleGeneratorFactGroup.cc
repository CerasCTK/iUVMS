...
VehicleGeneratorFactGroup::VehicleGeneratorFactGroup(QObject *parent)
    : FactGroup(1000, ":/json/Vehicle/GeneratorFact.json", parent), _statusFact(0, _statusFactName, FactMetaData::valueTypeUint64), _genSpeedFact(0, _genSpeedFactName, FactMetaData::valueTypeUint16),
      _batteryCurrentFact(0, _batteryCurrentFactName, FactMetaData::valueTypeFloat), _loadCurrentFact(0, _loadCurrentFactName, FactMetaData::valueTypeFloat), _powerGeneratedFact(0, _powerGeneratedFactName, FactMetaData::valueTypeFloat),
      _busVoltageFact(0, _busVoltageFactName, FactMetaData::valueTypeFloat), _rectifierTempFact(0, _rectifierTempFactName, FactMetaData::valueTypeInt16), _batCurrentSetpointFact(0, _batCurrentSetpointFactName, FactMetaData::valueTypeFloat),
      _genTempFact(0, _genTempFactName, FactMetaData::valueTypeInt16), _runtimeFact(0, _runtimeFactName, FactMetaData::valueTypeUint32), _timeMaintenanceFact(0, _timeMaintenanceFactName, FactMetaData::valueTypeInt32) {
...
void VehicleGeneratorFactGroup::handleMessage(Vehicle * /* vehicle */, mavlink_message_t &message) {
    switch (message.msgid) {
        case MAVLINK_MSG_ID_GENERATOR_STATUS: _handleGeneratorStatus(message); break;
        default: break;
    }
}
