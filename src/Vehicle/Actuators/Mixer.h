...
namespace Mixer {
    ...
    class ConfigParameter : public QObject {
        Q_OBJECT
      public:
        ConfigParameter(QObject *parent, Fact *fact, const QString &label, bool advanced) : QObject(parent), _fact(fact), _label(label), _advanced(advanced) {}
    ...
    class ChannelConfig : public QObject {
        Q_OBJECT
      public:
        ChannelConfig(QObject *parent, const MixerParameter &parameter, bool isActuatorTypeConfig = false) : QObject(parent), _parameter(parameter), _isActuatorTypeConfig(isActuatorTypeConfig) {}
    ...
    class ChannelConfigVirtualAxis : public ChannelConfig {
        Q_OBJECT
      public:
        ChannelConfigVirtualAxis(QObject *parent, const MixerParameter &parameter) : ChannelConfig(parent, parameter) {}
    ...
    class ChannelConfigInstanceVirtualAxis : public ChannelConfigInstance {
      ...
      public:
        ...
        ChannelConfigInstanceVirtualAxis(QObject *parent, ChannelConfig &config) : ChannelConfigInstance(parent, nullptr, config) {}
    ...
    class MixerConfigGroup : public QObject {
        Q_OBJECT
      public:
        MixerConfigGroup(QObject *parent, const MixerOption::ActuatorGroup &group) : QObject(parent), _group(group) {}
    ...
    class Mixers : public QObject {
        Q_OBJECT
      public:
        Mixers(ParameterManager *parameterManager) : _parameterManager(parameterManager) {}
