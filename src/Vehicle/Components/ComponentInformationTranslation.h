...
class ComponentInformationTranslation : public QObject {
  ...
  private:
    ...
    static QJsonObject translateItems(const QString &prefix, const QJsonObject &defs, const QJsonObject &translationObj, const QHash<QString, QString> &translations, QJsonObject jsonData);
    static QJsonValue translateTranslationItems(const QString &prefix, const QJsonObject &defs, const QJsonObject &translationObj, const QHash<QString, QString> &translations, QJsonValue jsonData);
