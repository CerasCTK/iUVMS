...
class RequestMetaDataTypeStateMachine : public StateMachine {
  ...
  private:
    ...
    static constexpr const StateFn _rgStates[] = {
        _stateRequestCompInfo, _stateRequestCompInfoDeprecated, _stateRequestMetaDataJson, _stateRequestMetaDataJsonFallback, _stateRequestTranslationJson, _stateRequestTranslate, _stateRequestComplete,
    };
...
class ComponentInformationManager : public StateMachine {
  ...
  private:
    ...
    static constexpr const StateFn _rgStates[]
        = { _stateRequestCompInfoGeneral, _stateRequestCompInfoGeneralComplete, _stateRequestCompInfoParam, _stateRequestCompInfoEvents, _stateRequestCompInfoActuators, _stateRequestAllCompInfoComplete };
