...
ADSBVehicleManager::ADSBVehicleManager(ADSBVehicleManagerSettings *settings, QObject *parent) : QObject(parent), _adsbSettings(settings), _adsbVehicleCleanupTimer(new QTimer(this)), _adsbVehicles(new QmlObjectListModel(this)) {
...
ADSBVehicleManager *ADSBVehicleManager::instance() { return _adsbVehicleManager(); }
