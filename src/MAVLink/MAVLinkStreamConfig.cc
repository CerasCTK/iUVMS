...
MAVLinkStreamConfig::MAVLinkStreamConfig(const SetMessageIntervalCb &messageIntervalCb) : _messageIntervalCb(messageIntervalCb) {}
...
void MAVLinkStreamConfig::gotSetMessageIntervalAck() {
    switch (_state) {
        case State::Configuring: nextDesiredRate(); break;
        case State::RestoringDefaults: restoreNextDefault(); break;
        default: break;
    }
}
