...
class HealthAndArmingCheckProblem : public QObject {
    Q_OBJECT
  public:
    HealthAndArmingCheckProblem(const QString &message, const QString &description, const QString &severity) : _message(message), _description(description), _severity(severity) {}
