...
namespace AndroidSerial {
    ...
    QByteArray read(int deviceId, int length, int timeout) {
        ...
        const jbyteArray jarray = static_cast<jbyteArray>(env->CallStaticObjectMethod(javaClass, methodId, static_cast<jint>(deviceId), static_cast<jint>(length), static_cast<jint>(timeout)));
    ...
    int write(int deviceId, const char *data, int length, int timeout, bool async) {
        ...
        if (async) {
            ...
            result = env->CallStaticIntMethod(javaClass, methodId, static_cast<jint>(deviceId), jarray, static_cast<jint>(timeout));
        } else {
            ...
            result = env->CallStaticIntMethod(javaClass, methodId, static_cast<jint>(deviceId), jarray, static_cast<jint>(length), static_cast<jint>(timeout));
        }
    ...
    bool setParameters(int deviceId, int baudRate, int dataBits, int stopBits, int parity) {
        ...
        const jboolean result = env->CallStaticBooleanMethod(javaClass, methodId, static_cast<jint>(deviceId), static_cast<jint>(baudRate), static_cast<jint>(dataBits), static_cast<jint>(stopBits), static_cast<jint>(parity));
    ...
    QSerialPort::PinoutSignals getControlLines(int deviceId) {
        ...
        for (jsize i = 0; i < len; ++i) {
            ...
            switch (value) {
                case 0: data |= QSerialPort::RequestToSendSignal; break;
                case 1: // CTS
                ...
                case 5: // RI
                    ...
                    break;
                default: qCWarning(AndroidSerialLog) << "Unknown ControlLine value:" << value; break;
            }
        }
    ...
    bool setFlowControl(int deviceId, int flowControl) {
        ...
        const jboolean result = env->CallStaticBooleanMethod(javaClass, methodId, static_cast<jint>(deviceId), static_cast<jint>(flowControl));
    ...
    bool purgeBuffers(int deviceId, bool input, bool output) {
        ...
        const jboolean result = env->CallStaticBooleanMethod(javaClass, methodId, static_cast<jint>(deviceId), jInput, jOutput);
