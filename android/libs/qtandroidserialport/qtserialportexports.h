...
#define QT_SERIALPORT_INLINE_SINCE(major, minor) QT_IF_DEPRECATED_SINCE(major, minor, inline, /* not inline */)
#define QT_SERIALPORT_INLINE_IMPL_SINCE(major, minor) 1
#else
...
#define QT_SERIALPORT_INLINE_SINCE(major, minor) QT_IF_DEPRECATED_SINCE(major, minor, inline, /* not inline */)
#define QT_SERIALPORT_INLINE_IMPL_SINCE(major, minor) QT_IF_DEPRECATED_SINCE(major, minor, 1, 0)
#endif
