...
void QGCFileDownloadTest::_testFileDownload() {
    ...
    (void)connect(downloader, &QGCFileDownload::downloadComplete, this, [this](const QString &remoteFile, const QString &localFile, const QString &errorMsg) {
        sender()->deleteLater();
...
void QGCFileDownloadTest::_testCachedFileDownload() { QGCCachedFileDownload file(""); }
