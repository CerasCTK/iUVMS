...
void CameraCalcTest::_testDirty(void) {
    ...
    QList<Fact *> rgFacts;
    rgFacts << _cameraCalc->valueSetIsDistance() << _cameraCalc->distanceToSurface() << _cameraCalc->imageDensity() << _cameraCalc->frontalOverlap() << _cameraCalc->sideOverlap() << _cameraCalc->adjustedFootprintSide()
