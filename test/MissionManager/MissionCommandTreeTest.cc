...
void MissionCommandTreeTest::init() { _commandTree = new MissionCommandTree(true /* unitTest */, this); }

QString MissionCommandTreeTest::_rawName(int id) const { return QStringLiteral("UNITTEST_%1").arg(id); }

QString MissionCommandTreeTest::_friendlyName(int id) const { return QStringLiteral("Unit Test %1").arg(id); }

QString MissionCommandTreeTest::_paramLabel(int index) const { return QStringLiteral("param%1").arg(index); }
