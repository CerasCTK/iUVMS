...
void SendMavCommandWithHandlerTest::_duplicateCommand(void) {
    ...
    SendMavCommandWithHandlerTest::TestCase_t testCase = { MockLink::MAV_CMD_MOCKLINK_NO_RESPONSE, MAV_RESULT_FAILED, 0, Vehicle::MavCmdResultFailureDuplicateCommand, 1 };
...
void SendMavCommandWithHandlerTest::_compIdAllFailure(void) {
    ...
    SendMavCommandWithHandlerTest::TestCase_t testCase = { MockLink::MAV_CMD_MOCKLINK_NO_RESPONSE, MAV_RESULT_FAILED, 0, Vehicle::MavCmdResultFailureDuplicateCommand, 0 };
