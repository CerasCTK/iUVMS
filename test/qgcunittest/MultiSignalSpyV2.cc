...
MultiSignalSpyV2::MultiSignalSpyV2(QObject *parent) : QObject(parent) {}
...
bool MultiSignalSpyV2::checkSignalByMask(quint64 mask) { return _checkSignalByMaskWorker(mask, false /* multipleSignalsAllowed */); }

bool MultiSignalSpyV2::checkOnlySignalByMask(quint64 mask) { return _checkOnlySignalByMaskWorker(mask, false /* multipleSignalsAllowed */); }

bool MultiSignalSpyV2::checkSignalsByMask(quint64 mask) { return _checkSignalByMaskWorker(mask, true /* multipleSignalsAllowed */); }

bool MultiSignalSpyV2::checkOnlySignalsByMask(quint64 mask) { return _checkOnlySignalByMaskWorker(mask, true /* multipleSignalsAllowed */); }
